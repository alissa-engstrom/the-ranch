<?php
/**
 * Template Name: Resources Center
 */
		...
		<div class="container">
	    	<div class="row">
	        	<div class="offset-lg-2 col-lg-8">
		        	...
		        	<?php the_field('top_resource_center_text', 'option'); ?>
        	...
        	<!--<div class="col-xs-12">-->
		        ...
		        <?php
		        	...
		        	$query = new WP_Query(
		        		...
		        		if( $query->have_posts() ):?>
		        		<h2 class="section-title"><?php echo '<a href="' . esc_url( $term_link ) . '">' . $term->name . '<span>View All</span</a>';?></h2>
		        		<div class="flex-container">
